...
public class CsvToJsonConverter {
	...
	public static void main(String[] args) {
        ...
        // --- Configuration ---
        String csvFilePath = "src/HCLEcatalog.csv"; // Path to the input CSV file
        String logFilePath = "src/output/parsing.log";     // Path for the output log file
        String jsonFilePath = "src/output/data.json";    // Path for the output JSON file
